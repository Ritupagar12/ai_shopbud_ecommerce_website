...
const Orders = () => {
  ...
  const filteredOrders = filterByStatus === "All"
    ? orders
      ...
      {/* Content */}
      {
        loading ? (
          ...
          <>
          {
                    ...
                    <div className="flex justify-between items-start flex-wrap gap-4">
                      ...
                      <div>
                        ...
                        <button
                          ...
                          className="ml-3 bg-red-500 hover:bg-red-600 text-white rounded px-3 py-1">Delete</button>
                      </div>
                    </div>
            ...
            {/* Delete Order Confirmation Model */}
            {
              deleteConfirm.open && (
                  ...
                  <div className="bg-white p-6 rounded shadow-lg text-center max-w-sm w-full"> 
                    ...
                    <div className="flex justify-center gap-4">
                      ...
                      className="bg-red-600 text-white px-4 py-2 rounded hover:bg-red-700">
                        ...
                        className="bg-gray-300 px-4 py-2 rounded hover:bg-gray-400">Cancle</button>
                    </div>
                  </div>
                </div>
              )
