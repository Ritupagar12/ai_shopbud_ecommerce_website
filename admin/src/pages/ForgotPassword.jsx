...
const ForgotPassword = () => {
  ...
  return <>
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-r from-blue-100 to-purple-200 px-4">
      <div className="bg-white shadow-lg rounded-2xl mx-w-md w-full p-8 sm:p-10">
        ...
        <form
          ...
          <div className="p-2">
            <label
              htmlFor="email"
              className="block text-sm font-medium text-gray-700 mb-1">Enter your email</label>
            <input
              type="email"
              name="email"
              value={email}
          ...
          <div className="px-2 flex justify-end items-center text-sm text-gray-500">
            <Link
              to={"/login"}
              type="button"
              className="text-blue-600 hover:underline">Remember Password?
            </Link>
          </div>
